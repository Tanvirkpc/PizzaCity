...
<nav class="navbar navbar-expand-lg text-danger navbar-white">
      <a class="navbar-brand text-danger" href="index.php">'.$systemName.'</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link text-danger" href="viewOrder.php">Your Orders</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-danger" href="about.php">About Us</a>
          </li>
          <li class="nav-item">
        ...
        <form method="get" action="/OnlinePizzaDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
          <input class="form-control text-danger mr-sm-2" type="search" name="search" id="search" placeholder="Search" aria-label="Search" required>
        ...
        if($loggedin){
          ...
          <div class="text-center image-size-small position-relative">
            <a href="viewProfile.php"><img src="img/person-' .$userId. '.jpg" class="rounded-circle text-danger" onError="this.src = \'img/profilePic.jpg\'" style="width:40px; height:40px"></a>
          </div>';
        }
        else {
          echo '
          <button type="button" class="btn btn-danger mx-2"  data-toggle="modal" data-target="#loginModal">Login</button>
          <button type="button" class="btn btn-danger mx-2"  data-toggle="modal" data-target="#signupModal">SignUp</button>';
        }
