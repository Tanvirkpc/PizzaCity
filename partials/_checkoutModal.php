        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Dhanmondi 9/A" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Address Line 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="Dhanmondi, Dhaka" type="text">
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="xxxx" required pattern="[0-9]{6}" maxlength="6">                    
                    </div>
                </div>
                <div class="form-group">
