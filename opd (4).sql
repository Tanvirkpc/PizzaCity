...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2024 at 08:20 AM
...
(1, 'PIZZA BURG', 'PizzaBurg is a modern pizza and burger focused restaurant. We try to be best in the business while being pocket friendly as wel.', '2021-03-17 18:16:28'),
(2, 'DOMINO\'S PIZZA', 'Choose your favourite pizzas from the Domino\'s Pizza menu. Get fresh pizza with your choice of crusts & toppings.', '2021-03-17 18:17:14'),
...
(8, 'CHOICE OF TOPPINGS', 'Some popular veg pizza toppings that you can add to your pizzas are black olives, baby corn, capsicum, red pepper, mushroom, paneer, jalapeno, tomato etc', '2021-03-18 08:13:47');
...
(1, 3, 'islam15-3949@diu.edu.bd', 1953363394, 2, 'dddddd', '2024-05-17 21:42:10'),
(2, 3, 'islam15-3949@diu.edu.bd', 1953363394, 2, 'Hi gggggg', '2024-05-24 11:59:39');
...
(1, 1, 3, 'Hi , what is your problem ?', '2024-05-17 21:42:57'),
(2, 2, 3, 'fffff', '2024-05-24 11:59:56');
...
(1, 1, 'Tanvir', 195336339, 7, '2024-05-24 12:04:34');
...
(1, 2, 'Dhanmondi 9/A, Dhaka', 134000, 175161347, 99, '0', '0', '2024-05-10 21:33:28'),
(2, 3, 'Dhaka, ', 100000, 1953363394, 448, '0', '4', '2024-05-17 21:29:58');
...
(38, 'Mirinda', 50, '500ml', 5, '2021-03-17 22:13:38'),
(39, 'PEPSI BLACK CAN', 70, 'PEPSI BLACK CAN', 5, '2021-03-17 22:14:24'),
(40, 'Pepsi\r\n', 52, '500ml', 5, '2021-03-17 22:16:29'),
(41, '7Up', 50, '500ml', 5, '2021-03-17 22:17:08'),
...
(1, 'Pizza City', 'islam15-3949@diu.edu.bd', 1953363394, 1754161347, 'Thana Road.<br> Dhanmondi', '2021-03-23 19:56:25');
...
(2, 'arhamdippo', 'Arham', 'Dippo', 'mahbub15-3963@diu.edu.bd', 175161347, '0', '$2y$10$kxF9/hvKXecg2a88PCuNQ.7BmzVvgnuHnVCXkieevy6GQL7DTCXGy', '2024-05-10 21:29:43'),
(3, 'TANVIR', 'Thahidul', 'Islam', 'islam15-3949@diu.edu.bd', 1953363394, '0', '$2y$10$uuS7xHJCxzqrv48GpYujj.xLEXkKHB8ge7h/hCDvA1a0gDxjG.Xbe', '2024-05-17 21:27:22');
