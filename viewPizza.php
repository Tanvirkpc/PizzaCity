...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
                <img src="img/pizza-'.$pizzaId. '.jpg" width="249px" class=" rounded" height="262px">
            </div>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-danger my-2">Add to Cart</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-danger my-2">Go to Cart</button></a>';
                    }
                }
                else{
                    echo '<button class="btn btn-danger my-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                }
                echo '</form>
