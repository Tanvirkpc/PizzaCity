      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza City</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0"></h2><p> <a href="https://github.com" target="_blank"></a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pizza City</strong></h3>
            <h3><strong>The World's Leader in Pizza Delivery</strong></h3>
            <p class="font-italic">
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 400px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="img\Tanvir.jpg" class="img-fluid" alt="" style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Thahidul Islam</h4>
                </div>
                <div class="social">
                  <a href="https://twitter.com" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/Tanvirkpc" target="_blank"><i class="fab fa-github"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="img\dippo.JPG" class="img-fluid" alt="" style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Arham Mahbub</h4>
                </div>
