    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-4 mb-4">
                        <div class="card" style="height: 33rem;">
                            <img src="img/pizza-'.$pizzaId. '.jpg" class="card-img-top img-fluid" alt="image for this pizza" height="250px" >
                            <div class="card-body">
                                <h5 class="card-title">' . substr($pizzaName, 0, 25). '...</h5>
                                <h6 style="color: #ff0000">Tk. '.$pizzaPrice. '/-</h6>
                                <p class="card-text">' . substr($pizzaDesc, 0, 30). '...</p>   
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn btn-danger mx-2">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn btn-danger mx-2">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-danger mx-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                            echo '</form>                            
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '" class="mx-2"><button class="btn btn-danger">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
